...
clear = Button(btns_frame, text="C", fg="black", width=32, height=3, bd=0, bg="yellow",
               cursor="hand2", command=lambda: bt_clear()).grid(row=0, column=0, columnspan=3, padx=1, pady=1)
root = Button(btns_frame, text="")
...
equals = Button(btns_frame, text="=", fg="black", width=10, height=3, bd=0, bg="red",
